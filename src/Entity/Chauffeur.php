...
/**
 * @ORM\Entity(repositoryClass="App\Repository\ChauffeurRepository", repositoryClass=ChauffeurRepository::class)
 * @ApiResource()
 */
class Chauffeur
{
    ...
    public function getCarteNI(): ?int
    {
        return $this->carteNI;
    }

    public function setCarteNI(int $carteNI): self
    {
        $this->carteNI = $carteNI;
